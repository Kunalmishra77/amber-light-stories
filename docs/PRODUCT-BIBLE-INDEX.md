...
| 5 | **Complete Automation Engine** | ✍️ Draft v1.0 (Awaiting Review) | `product-bible/PART-5-automation-engine.md` | 16 deliverables; vocabulary, lifecycle, workflow/job/scheduler/trigger/execution engines, failure recovery, cost governor, isolation; +12 backlog items (M11); ADR-030…034 |
...
| Topic | Status | Notes |
|---|---|---|
| **AI Pipeline** (generation contract) | ⏳ Awaiting | may be folded into/extend Part 5; → M4/M11 |
| **Manual vs Automatic Workflow** | ⏳ Awaiting | largely covered by Part 3 §8 + Part 5 §15.10; may be a dedicated part |
...
- 2026-07-20 — **Part 5 (Draft v1.0, Awaiting Review)** authored: complete Automation Engine — canonical vocabulary, automation lifecycle state machine, Workflow/DAG engine, universal Job engine, Scheduler, event-driven Trigger router, Execution engine, layered Failure Recovery, engine-level Cost Governor, Manual/Auto execution, Observability, Multi-Tenant Isolation, Provider Abstraction. 16 deliverables. +12 backlog items (ISS-P5-01…12), new epic **M11** (durable workflow/job runtime, absorbs M4/M5); ADR-030…034. **Not locked — awaiting owner review.**

...
| 8 | **Subscription, Billing, Credits & Commercial** | ✍️ Draft v1.0 (Awaiting Review) | `product-bible/PART-8-subscription-billing-commercial.md` | 14 deliverables; subscription/entitlement/usage/credit/billing/payment/tax/promotion/revenue/enterprise-commercial; +12 backlog items (M9); ADR-060…064 |

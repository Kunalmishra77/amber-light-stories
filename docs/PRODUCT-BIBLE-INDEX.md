...
| 10 | **Manual vs Automatic Workflow, Human Review & Operations** | ✍️ Draft v1.0 (Awaiting Review) | `product-bible/PART-10-manual-auto-workflow-operations.md` | 14 deliverables; 3 modes over per-stage matrix, approval system, Review/Operations/Notification centers, versioned editing, collaboration, operational analytics; +10 backlog items (M15); ADR-080…082 |
